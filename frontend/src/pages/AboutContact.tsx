...
import himdev from "../assets/himdev.png"
...
export default function AboutContactPage() {
  ...
  const team: TeamMember[] = [
    {
      name: "Himdev Vitthal Nikode",
      role: " member of the team",
      image: himdev,
      bio: "Himdev is a passionate software engineer with a knack for building scalable web applications. He has a strong background in full-stack development and is always eager to learn new technologies.",
      expertise: ["React", "Node.js", "TypeScript", "GraphQL"],
      achievements: ["Developed a real-time chat application"],
      social: {
